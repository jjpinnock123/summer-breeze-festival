...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-black/35 py-12">
      <div className="mx-auto flex w-full max-w-12xl flex-col gap-8 px-4 text-sm text-white/65 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr_0.8fr]">
          <div>
            <div className="flex flex-wrap items-center gap-4">
              <div className="relative h-48 w-48 overflow-hidden rounded-[1.75rem] border border-white/15 bg-white/8 shadow-[0_14px_34px_rgba(0,0,0,0.24)] ring-1 ring-yellow-300/10 sm:h-56 sm:w-56">
